...
class GraphicDisplay(tk.Tk):
    def __init__(self, mc_name):
        ...
        self.f_img, self.b_img, self.m_img = self.load_images()
    ...
    @staticmethod
    def load_images():
        flight_img = ImageTk.PhotoImage(Image.open("./img/rectangle.png").resize((10, 10)))
        battery_img = []
        missile_img = []
        for i in range(12):
            battery_img.append(ImageTk.PhotoImage(Image.open("./img/triangle%d.png" % i).resize((10, 10))))
        for i in range(12):
            missile_img.append(ImageTk.PhotoImage(Image.open("./img/circle%d.png" % i).resize((10, 10))))
        return flight_img, battery_img, missile_img
